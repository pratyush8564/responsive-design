...
const Solutions = () => {
  return (
    <div className="flex flex-wrap  items-center justify-center md:mt-[7rem]">
      <div className="xl:w-6/12 lg:w-6/12 md:w-full px-[15px] max-w-full md:px-[20px]">
        <div className="flex flex-wrap mx-[-12.5px] md:mx-[-12.5px] justify-center md:justify-start">
          ...
          <div className="w-full md:w-1/2 px-[12.5px] md:px-[25.5px] flex sm:justify-center xs:justify-center max-w-full mt-[25px]">
            <figure className="rounded-[0.4rem]">
              <img className="rounded-[0.4rem]" src="g9.jpg" alt="image" />
            </figure>
          </div>
          <div className="w-full md:w-1/2 px-[12.5px] md:px-[12.5px] flex sm:justify-center xs:justify-center    max-w-full mt-[25px]">
            <figure className="rounded-[0.4rem]">
              <img className="rounded-[0.4rem]" src="g10.jpg" alt="image" />
            </figure>
          </div>
        </div>
      </div>
      <div className="xl:w-6/12 lg:w-6/12 md:w-full px-[15px] max-w-full md:px-[20px] md:mt-[80px]">
      <div className="text-center md:text-center lg:text-left">
        <h2 className="text-sm tracking-[0.02rem] uppercase text-[#aab0bc] md:mb-8 sm:mt-16">
          What Makes Us Different?
        </h2>
        <h3 className="text-4xl md:text-[2.1rem] leading-[1.2] font-semibold mb-8">
          We bring{" "}
          <span className="relative after:content-[''] after:absolute after:z-[-1] after:block after:bg-no-repeat after:bg-bottom after:bottom-[-0.1em] after:w-[110%] after:h-[0.3em] after:-translate-x-2/4 after:left-2/4 style-2 yellow">
            solutions
          </span>{" "}
          to make life easier for our customers.
        </h3>
        <div className="flex flex-wrap mx-[-12.5px] mt-[30px] justify-center md:justify-start">
          <div className="w-full md:w-1/2 px-[12.5px] max-w-full mt-[30px]">
            <div className="flex items-center justify-center md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 256 256"
                className="w-[1.8rem] h-[1.8rem] solid-mono text-[#e668b3] text-fuchsia mr-4"
              >
                <path
          ...
          <div className="w-full md:w-1/2 px-[12.5px] max-w-full mt-[30px]">
            <div className="flex items-center justify-center md:justify-start">
              <svg
                ...
                className="w-[1.8rem] h-[1.8rem] solid-mono text-[#a07cc5] text-violet mr-4"
              >
                <circle
                  className="fill-primary"
                  cx="58.67"
                ...
                <path
                  className="fill-secondary"
                  d="M149.76 108.48v7.68A11.9 11.9 0 01137.81 128h-19.63c-5.76 0-12-4.27-12-13.76v-5.76zM108 108.48v7.68a11.9 11.9 0 0011.95 11.84h19.63c5.76 0 12-4.27 12-13.76v-5.76z"
                ></path>
                <path
                  className="fill-primary"
                  d="M59.3 208.42c-1.78 0-3.62-.71-5.15-2.24-3.85-3.85-4.44-9.72-1.39-14.25l.26-.36 32.42-32.42.08-.12c3.89-3.89 4.48-9.89 1.36-14.43a9 9 0 0113.45-1.08l.18.18 18.68 20.69c.47.53 1.14.83 1.82.83s1.36-.3 1.82-.83l18.68-20.69.18-.18a9 9 0 0113.45 1.08c3.89 4.54 2.5 10.54-1.39 14.43l.08.12 32.42 32.42.26.36c3.05 4.53 2.46 10.4-1.39 14.25a7.3 7.3 0 01-5.15 2.24z"
                ></path>
              </svg>
              <div>
          ...
          <div className="w-full md:w-1/2 px-[12.5px] max-w-full mt-[30px]">
            <div className="flex items-center justify-center md:justify-start">
              <svg
                ...
                className="w-[1.8rem] h-[1.8rem] solid-mono text-[#f78b77] text-orange mr-4"
              >
                <path
                  className="fill-secondary"
          ...
          <div className="w-full md:w-1/2 px-[12.5px] max-w-full mt-[30px]">
            <div className="flex items-center justify-center md:justify-start">
              <svg
                ...
                className="w-[1.8rem] h-[1.8rem] solid-mono text-[#45c4a0] text-green mr-4"
              >
                <path
                  className="fill-secondary"
                  d="M35.72 92.28a92.28 92.28 0 01184.56 0v47.63a8.93 8.93 0 01-17.86 0V92.28a74.42 74.42 0 10-148.84 0v47.63a8.93 8.93 0 01-17.86 0zm175.63 62.51a8.93 8.93 0 018.93 8.93v35.72a32.75 32.75 0 01-32.75 32.75h-35.72a8.94 8.94 0 010-17.87h35.72a14.88 14.88 0 0014.89-14.88v-35.72a8.93 8.93 0 018.93-8.93z"
                ></path>
                <path
                  className="fill-secondary"
